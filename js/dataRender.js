...
const getPopUp = (value) => {
    ...
    <img src="./timeline/OOjs_UI_icon_close.svg.png" id="close-img" type="button" data-dismiss="modal">
...
const imageList = (value) => {
    ...
    pickedAlbum.media.forEach((item, i) => {
        ...
        if (item.video) {
            ...
            list[0] += `<div class="mySlides" id="picked-image">
            <iframe width="100%" id="frame-video" src="${videoLink}" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
            <h1 style="text-align:right; font-size: 1.8vw;
            font-weight: 900;
